...
//                .logoutSuccessUrl("http://192.168.0.183:8080/realms/external/protocol/openid-connect/logout?redirect_uri=http://localhost:8081/")
//                .logoutSuccessUrl("http://192.168.0.183:8080/realms/IDP_REALM/protocol/saml?redirect_uri=http://192.168.0.181:8082")
                .logoutSuccessUrl("http://192.168.0.183:8080/realms/IDP_REALM/protocol/saml/logout?redirect_uri=http://192.168.0.181:8082")
                .invalidateHttpSession(true);
*/

//        http.logout()
//                .logoutRequestMatcher(new AntPathRequestMatcher("/saml/logout"))
//                .logoutSuccessUrl("http://192.168.0.183:8080/realms/IDP_REALM/protocol/saml?redirect_uri=http://localhost:8082/")
//                .invalidateHttpSession(true)
//                .clearAuthentication(true);

//        http.logout()
//                .logoutRequestMatcher(new AntPathRequestMatcher("/saml/logout"))
//                .logoutSuccessUrl("http://192.168.0.183:8080/realms/IDP_REALM/protocol/saml/logout?redirect_uri=http://localhost:8082/")
//                .invalidateHttpSession(true)
//                .clearAuthentication(true);
...
//        http.logout()
//                .logoutRequestMatcher(new AntPathRequestMatcher("/saml/logout"))
//                .logoutSuccessUrl("http://192.168.0.183:8080/auth/realms/your-realm/protocol/saml/logout")
//                .invalidateHttpSession(true)
//                .clearAuthentication(true);

        http.logout()
                .logoutRequestMatcher(new AntPathRequestMatcher("/saml/logout"))
//                .deleteCookies("DA98399BDECF1E6A5E819C0A1FC4C67D")
                .logoutSuccessUrl("http://192.168.0.183:8080/auth/realms/your-realm/protocol/saml/logout")
                .invalidateHttpSession(true)
                .clearAuthentication(true);
